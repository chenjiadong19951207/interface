...
if __name__ == '__main__':
    ...
    dicover = unittest.defaultTestLoader.discover(case_path,pattern="run_case_*.py")
    with open(report_path,'wb') as f:
        runner = HTMLTestRunner.HTMLTestRunner(stream=f,title='123',desciption='this is test')
        runner.run(dicover)
